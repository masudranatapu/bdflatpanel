...
class PoslazuAbstract implements PoslazuInterface
{
    ...
    protected $country;
    protected $dispatch;
    protected $api_key      = env('POSLAJU_API_KEY');
  ...
  public function getConsignmentNote($request){
   ...
   // $sender_address_line_1      = $order->FROM_ADDRESS_LINE_1;
    ...
    $post_url   = 'https://sendparcel.poslaju.com.my/apiv1/create_shipment';
  ...
  DB::commit();
  return $this->formatResponse(true,'Dispatch successfull !','admin.order.list');
  ...
  public function  getTrackingId($id)
  {
    ...
    {
         $SERVER_API_KEY = env('POSLAJU_API_KEY');
        // $data = [
        ...
        // echo '<br>======================';
        // exit();
        $data = "api_key=$SERVER_API_KEY&shipment_keys=$key";
           // $data                   =' api_key="kf0ecfaac86c2c240ea14d276cee0a4d5","shipment_keys":["'.$key.'",]';
            $curl = curl_init();
            curl_setopt_array($curl, array(
              CURLOPT_URL => 'https://sendparcel.poslaju.com.my/apiv1/checkout',
              CURLOPT_RETURNTRANSFER => true,
              CURLOPT_ENCODING => '',
              CURLOPT_MAXREDIRS => 10,
              CURLOPT_TIMEOUT => 0,
    ...
    public function getCartList($request){
       ...
       // $post_url = 'http://sendparcel-test.ap-southeast-1.elasticbeanstalk.com/apiv1/get_cart_items';
        $post_url = 'https://sendparcel.poslaju.com.my/apiv1/get_cart_items';
    ...
    public function cartCheckout($key)
    {
        ...
        curl_setopt_array($curl, array(
          ...
          CURLOPT_HTTP_VERSION => CURL_HTTP_VERSION_1_1,
          CURLOPT_CUSTOMREQUEST => 'POST',
          CURLOPT_POSTFIELDS => array('api_key' => env('POSLAJU_API_KEY'),'shipment_keys' => '".$key."'),
          CURLOPT_HTTPHEADER => array(
          ),
        ));
    ...
    public function getShipmentStatus(){
       ...
       // $post_url               = 'http://sendparcel-test.ap-southeast-1.elasticbeanstalk.com/apiv1/get_shipment_statuses';
        $post_url               = 'https://sendparcel.poslaju.com.my/apiv1/get_shipment_statuses';
    ...
    public function getShipmentInfoBykey($shipment_keys){
        ...
        curl_setopt_array($curl, array(
          CURLOPT_URL => 'https://sendparcel.poslaju.com.my/apiv1/get_shipments',
          CURLOPT_RETURNTRANSFER => true,
          CURLOPT_ENCODING => '',
          CURLOPT_MAXREDIRS => 10,
          CURLOPT_TIMEOUT => 0,
