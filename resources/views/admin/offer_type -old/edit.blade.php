        ...
        <div class="col-md-12">
            <div class="card card-success">
                <div class="card-content collapse show">
                    <div class="card-body">
                        {!! Form::open([ 'route' => ['admin.offer_type.update',$row->PK_NO], 'method' => 'post', 'class' => 'form-horizontal', 'files' => true , 'novalidate']) !!}
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group {!! $errors->has('name') ? 'error' : '' !!}">
                                        <label>@lang('form.product_form_field_name')<span class="text-danger">*</span></label>
                                        <div class="controls">
                                            {!! Form::text('name', $row->NAME, [ 'class' => 'form-control mb-1', 'placeholder' => 'Enter offer type name', 'data-validation-required-message' => 'This field is required', 'tabindex' => 1 ]) !!}
                                ...
                                <div class="col-md-6">
                                    <div class="form-group {!! $errors->has('public_name') ? 'error' : '' !!}">
                                        ...
                                        <div class="controls">
                                            {!! Form::text('public_name', $row->PUBLIC_NAME, [ 'class' => 'form-control mb-1', 'placeholder' => 'Enter offer type public name', 'data-validation-required-message' => 'This field is required', 'tabindex' => 1 ]) !!}
                                ...
                                <div class="col-md-2">
                                    <div class="form-group {!! $errors->has('p2_amount') ? 'error' : '' !!}">
                                        ...
                                        <div class="controls">
                                            {!! Form::number('p2_amount', $row->P2_AMOUNT, [ 'class' => 'form-control mb-1', 'placeholder' => 'Enter P2 amount', 'data-validation-required-message' => 'This field is required', 'tabindex' => 1 ]) !!}
                                ...
                                <div class="col-md-2">
                                    <div class="form-group {!! $errors->has('r_ss') ? 'error' : '' !!}">
                                        ...
                                        <div class="controls">
                                            {!! Form::number('r_ss', $row->R_SS, [ 'class' => 'form-control mb-1', 'placeholder' => 'Enter SS cost for B list', 'data-validation-required-message' => 'This field is required', 'tabindex' => 1 ]) !!}
                                ...
                                <div class="col-md-2">
                                    <div class="form-group {!! $errors->has('r_sm') ? 'error' : '' !!}">
                                        ...
                                        <div class="controls">
                                            {!! Form::number('r_sm', $row->R_SM, [ 'class' => 'form-control mb-1', 'placeholder' => 'Enter SM cost for B list', 'data-validation-required-message' => 'This field is required', 'tabindex' => 1 ]) !!}
                                ...
                                <div class="col-md-2">
                                    <div class="form-group {!! $errors->has('r_air') ? 'error' : '' !!}">
                                        ...
                                        <div class="controls">
                                            {!! Form::number('r_air', $row->R_AIR, [ 'class' => 'form-control mb-1', 'placeholder' => 'Enter AIR cost for B list', 'data-validation-required-message' => 'This field is required', 'tabindex' => 1 ]) !!}
                                ...
                                <div class="col-md-2">
                                    <div class="form-group {!! $errors->has('r_sea') ? 'error' : '' !!}">
                                        ...
                                        <div class="controls">
                                            {!! Form::number('r_sea', $row->R_SEA, [ 'class' => 'form-control mb-1', 'placeholder' => 'Enter SEA cost for B list', 'data-validation-required-message' => 'This field is required', 'tabindex' => 1 ]) !!}
