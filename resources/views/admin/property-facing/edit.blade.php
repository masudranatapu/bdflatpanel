                    ...
                    <div class="card card-sm card-success">
                        ...
                        <div class="card-content collapse show">
                            <div class="card-body card-dashboard">
                                {!! Form::open([ 'route' => ['admin.property.facing.update', $data['facing']->PK_NO], 'method' => 'post', 'class' => 'form-horizontal', 'files' => true , 'novalidate']) !!}
                                <div class="row">
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                {!! Form::text('order_id', old('order_id', $data['facing']->ORDER_ID), ['class' => 'form-control', 'data-validation-required-message' => 'This field is required', 'placeholder' => 'Order ID']) !!}
                                    ...
                                    <div class="col-md-12">
                                        <a href="{{ route('admin.property.facing')}}">
