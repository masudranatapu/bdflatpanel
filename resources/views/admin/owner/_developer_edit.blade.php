<div class="row">
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <div class="controls">
                {!! Form::text('meta_title', old('meta_title', $owner->info->META_TITLE ?? ''), ['class' => 'form-control', 'placeholder' => 'Meta Title', 'tabIndex' => ++$tabIndex, 'data-validation-required-message' => 'This field is required']) !!}
