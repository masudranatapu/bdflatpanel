                                ...
                                <div class="col-md-6">
                                    <div class="mb-2">
                                        ...
                                        <h3 class="font-weight-bold">
                                            BDT {{ number_format($data['owner']->UNUSED_TOPUP ?? 0, 2) }}</h3>
                                    </div>
                                    {!! Form::open(['route' => ['admin.owner.recharge', $data['owner']->PK_NO],'method' => 'post', 'class' => 'form-horizontal', 'files' => true , 'novalidate', 'autocomplete' => 'off']) !!}
