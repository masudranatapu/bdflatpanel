            ...
            <div class="modal-header">
                ...
                <div class="modal-body">
                    <div class="form-group {!! $errors->has('warehouse') ? 'error' : '' !!}">
                        ...
                        <div class="controls">
                            {!! Form::select('warehouse', $warehouse_combo, null, [ 'class' => 'form-control mb-1 select2', 'placeholder' => 'Please select warehouse', 'data-validation-required-message' => 'This field is required', 'tabindex' => 4]) !!}
