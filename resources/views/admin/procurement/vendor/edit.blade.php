                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group {!! $errors->has('phone') ? 'error' : '' !!}">
                                ...
                                <div class="controls">
                                    {!! Form::text('phone', $vendor->PHONE,[ 'class' => 'form-control mb-1', 'data-validation-required-message' => 'This field is required', 'placeholder' => 'Enter phone number', 'tabindex' => 2 ]) !!}
                        ...
                        <div class="col-md-4">
                            <div class="form-group {!! $errors->has('country') ? 'error' : '' !!}">
                                ...
                                <div class="controls">
                                    {!! Form::select('country', $country, $vendor->F_COUNTRY, [ 'class' => 'form-control mb-1 select2', 'placeholder' => 'Please select country', 'data-validation-required-message' => 'This field is required', 'tabindex' => 3]) !!}
                        ...
                        <div class="col-md-4">
                            <div class="form-group {!! $errors->has('has_loyality') ? 'error' : '' !!}">
                                ...
                                <div class="controls">
                                    {!! Form::select('has_loyality', ['1' => 'Yes', '0' => 'No'], $vendor->HAS_LOYALITY, [ 'class' => 'form-control mb-1 select2', 'placeholder' => 'Please select', 'data-validation-required-message' => 'This field is required', 'tabindex' => 4]) !!}
                        ...
                        <div class="col-md-8">
                            <div class="form-group {!! $errors->has('address') ? 'error' : '' !!}">
                                ...
                                <div class="controls">
                                    {!! Form::text('address', $vendor->ADDRESS,[ 'class' => 'form-control mb-1', 'data-validation-required-message' => 'This field is required', 'placeholder' => 'Enter address', 'tabindex' => 5 ]) !!}
