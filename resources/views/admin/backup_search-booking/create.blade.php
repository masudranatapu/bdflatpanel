            ...
            <div class="row">
                <div class="col-md-12">
                            ...
                            <div class="col-md-5">
                                <div class="form-group {!! $errors->has('ig_code') ? 'error' : '' !!}">
                                    ...
                                    <div class="controls" id="scrollable-dropdown-menu">
                                        <input type="search" name="q" id="product" class="form-control search-input" placeholder="Enter Product Keyword" autocomplete="off" required>
                                    ...
                                    <table class="table table-striped table-borde table-sm" id="invoicetable">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="text-center" style="width: 70px;">@lang('tablehead.warehouse')</th>
                                        ...
                                        <tfoot id="append_tfoot">
                                            ...
                                            <tr style="text-align: center">
                                                ...
                                                {{-- <td><input type="number" style="width: 60px;text-align: center;" class="form-control input-sm ml-2" id="amount_freight2"></td> --}}
                                                <td></td>
                                            </tr>
                                            <tr style="text-align: center">
                                                <td></td>
                                                ...
                                                {{-- <td><input type="number" style="width: 60px;text-align: center;" class="form-control input-sm ml-2" id="postage_cost2"></td> --}}
                                            </tr>
                                            <tr style="text-align: center">
                                                <th></th>
                                                <th>Grand Total</th>
                            ...
                            <div class="row">
                                ...
                                <div id="cus_mobile" class="col-md-2">
                                    {{-- <div class="form-group {!! $errors->has('custom_mobile') ? 'error' : '' !!}">
                                        ...
                                        <div class="controls">
                                            {!! Form::text('custom_mobile','+60 1',[ 'class' => 'form-control', 'placeholder' => 'Enter Customer Mobile', 'id' => 'cus_mobile_input']) !!}
                    ...
                    <div class="form-actions mt-10 text-center">
                        ...
                        <button type="button" id="submit_button_book2" class="btn btn-info save-inv-details mr-1"><i class="la la-check-square-o"></i> Proceed to Booking </button>
                        <a href="javascript:void(0)" id="book_2_order2"><button type="button" class="btn btn-info save-inv-details"><i class="la la-check-square-o"></i> Book & Make Order </button></a>
                    </div>
                    {!! Form::close() !!}
                </div>
            </div>
...
<script type="text/javascript" src="{{ asset('app-assets/pages/cus_pro_search.js?v-1.02')}}"></script>
<script type="text/javascript" src="{{ asset('app-assets/pages/book_order.js?v-1.55')}}"></script>
<script type="text/javascript" src="{{ asset('app-assets/js/common.js?v-1.01')}}"></script>
