        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="form-group {!! $errors->has('addresstype') ? 'error' : '' !!}">
                    ...
                    {!! Form::select('addresstype', $address, null, ['class'=>'form-control mb-1 select2', 'data-validation-required-message' => 'This field is required', 'id' => 'addresstype']) !!}
            ...
            <div class="col-md-4">
                {{-- <div class="form-group {!! $errors->has('mobilenoadd') ? 'error' : '' !!}">
                    ...
                    <div class="controls">
                        {!! Form::text('mobilenoadd', null, [ 'class' => 'form-control mb-1','placeholder' => 'Enter Mobile No', 'tabindex' => 2, 'id' => 'mobilenoadd']) !!}
            ...
            <div class="col-md-4">
                {{-- <div class="form-group {!! $errors->has('country') ? 'error' : '' !!}">
                    ...
                    <div class="controls">
                        {!! Form::select('country', $country ?? array(), 2, ['class'=>'form-control mb-1 select2',
        ...
        <div class="row" id="display_none" style="display: none">
            ...
            {{-- <div class="col-md-4">
                <div class="form-group {!! $errors->has('mobilenoadd2') ? 'error' : '' !!}">
                    <label>{{trans('form.mobile_no')}}</label>
                    <div class="controls">
                        {!! Form::text('mobilenoadd2', null, [ 'class' => 'form-control mb-1','id'=>'mobilenoadd2','placeholder' => 'Enter Mobile No', 'tabindex' => 2]) !!}
            ...
            {{-- <div class="col-md-4">
                <div class="form-group {!! $errors->has('country2') ? 'error' : '' !!}">
                    <label>{{trans('form.country')}}</label>
                    <div class="controls">
                        {!! Form::select('country2', $country ?? array(), 2, ['class'=>'form-control mb-1 select2', 'id' => 'country2', 'placeholder' => 'Select Country', 'data-url' => URL::to('customer_state' ), 'tabindex' => 1 ]) !!}
