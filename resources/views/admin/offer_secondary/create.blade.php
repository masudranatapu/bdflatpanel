...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item active">@lang('form.offer_secondary_list_add')    </li>
@endsection
            ...
            <div class="col-md-12">
                <div class="card card-success">
                    <div class="card-content collapse show">
                        <div class="card-body">
                            {!! Form::open([ 'route' => 'admin.offer_secondary.store', 'method' => 'post', 'class' => 'form-horizontal', 'files' => true , 'novalidate']) !!}
                                <div class="row">
                                <div class="col-md-12">
                                ...
                                <div class="form-actions text-center mt-3">
                                    <a href="{{ route('admin.offer_secondary.list') }}" class="btn btn-warning mr-1" ><i class="ft-x"></i> @lang('form.btn_cancle')</a>
