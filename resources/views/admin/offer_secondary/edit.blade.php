...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item active">Edit secondary list </li>
@endsection
        ...
        <div class="col-md-12">
            <div class="card card-success">
                <div class="card-content collapse show">
                    <div class="card-body">
                        {!! Form::open([ 'route' => ['admin.offer_secondary.update',$row->PK_NO], 'method' => 'post', 'class' => 'form-horizontal', 'files' => true , 'novalidate']) !!}
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group {!! $errors->has('name') ? 'error' : '' !!}">
                                        ...
                                        <div class="controls">
                                            {!! Form::text('name', $row->SECONDARY_SET_NAME, [ 'class' => 'form-control mb-1', 'placeholder' => 'Enter name', 'data-validation-required-message' => 'This field is required', 'tabindex' => 1 ]) !!}
                            ...
                            <div class="form-actions text-center mt-3">
                                <a href="{{ route('admin.offer_secondary.list') }}" class="btn btn-warning mr-1" title="Cancel"> <i class="ft-x"></i> @lang('form.btn_cancle') </a>
