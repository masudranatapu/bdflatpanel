                        ...
                        <div class="card border-grey border-lighten-3 m-0">
                            <div class="card-header border-0">
                                ...
                                <div class="card-title text-center">
                                    <div class="p-1"><img src="{{url('app-assets/images/logo/logo-80x80.png')}}" alt="branding logo" ></div>
                                </div>
                                @if ($errors->any())
                                ...
                                <div class="card-body pt-0">
                                    <form class="form-horizontal" method="post" action="{{ url('admin') }}">
                                        ...
                                        <fieldset class="form-group floating-label-form-group">
                                            ...
                                            <input type="email" class="form-control" name="email" placeholder="Your Email" value="admin@admin.com">
                                        </fieldset>
