            ...
            <div class="col-md-12">
                <div class="card card-sm card-success">
                    <div class="card-content">
                        <div class="card-body">
                            {!! Form::open([ 'route' => 'web.team_members.store', 'method' => 'post', 'class' => 'form-horizontal', 'files' => true , 'novalidate']) !!}
                            <div class="row">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group {!! $errors->has('designation') ? 'error' : '' !!}">
                                        ...
                                        <div class="controls">
                                            {!! Form::text('designation', null, [ 'class' => 'form-control mb-1', 'data-validation-required-message' => 'This field is required', 'placeholder' => 'Enter Designation', 'tabindex' => 2]) !!}
                                ...
                                <div class="col-md-6">
                                    <div class="form-group {!! $errors->has('fb_url') ? 'error' : '' !!}">
                                        ...
                                        <div class="controls">
                                            {!! Form::text('fb_url', null, [ 'class' => 'form-control mb-1', 'data-validation-required-message' => 'This field is required', 'placeholder' => 'Enter FB Url', 'tabindex' => 1]) !!}
                                ...
                                <div class="col-md-6">
                                    <div class="form-group {!! $errors->has('twitter_url') ? 'error' : '' !!}">
                                        ...
                                        <div class="controls">
                                            {!! Form::text('twitter_url', null, [ 'class' => 'form-control mb-1', 'data-validation-required-message' => 'This field is required', 'placeholder' => 'Enter Twitter Url', 'tabindex' => 2]) !!}
                                ...
                                <div class="col-md-6">
                                    <div class="form-group {!! $errors->has('linkedin_url') ? 'error' : '' !!}">
                                        ...
                                        <div class="controls">
                                            {!! Form::text('linkedin_url', null, [ 'class' => 'form-control mb-1', 'data-validation-required-message' => 'This field is required', 'placeholder' => 'Enter Linkedin Url', 'tabindex' => 1]) !!}
                                ...
                                <div class="col-md-6">
                                    <div class="form-group {!! $errors->has('printerest_url') ? 'error' : '' !!}">
                                        ...
                                        <div class="controls">
                                            {!! Form::text('printerest_url', null, [ 'class' => 'form-control mb-1', 'data-validation-required-message' => 'This field is required', 'placeholder' => 'Enter Printerest Url', 'tabindex' => 2]) !!}
