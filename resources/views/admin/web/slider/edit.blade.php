            ...
            <div class="col-md-12">
                <div class="card card-sm card-success">
                    <div class="card-content">
                        <div class="card-body">
                            {!! Form::open([ 'route' => ['web.home.slider.update',$row->PK_NO], 'method' => 'post', 'class' => 'form-horizontal', 'files' => true , 'novalidate']) !!}
                            @csrf
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group {!! $errors->has('title') ? 'error' : '' !!}">
                                        ...
                                        <div class="controls">
                                            {!! Form::text('title', $row->TITLE, [ 'class' => 'form-control mb-1', 'data-validation-required-message' => 'This field is required', 'placeholder' => 'Enter Title', 'tabindex' => 5]) !!}
                                ...
                                <div class="col-md-6">
                                    <div class="form-group {!! $errors->has('subtitle') ? 'error' : '' !!}">
                                        ...
                                        <div class="controls">
                                            {!! Form::text('subtitle', $row->SUBTITLE, [ 'class' => 'form-control mb-1', 'data-validation-required-message' => 'This field is required', 'placeholder' => 'Enter subtitle', 'tabindex' => 5]) !!}
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group {!! $errors->has('url_link') ? 'error' : '' !!}">
                                        ...
                                        <div class="controls">
                                            {!! Form::url('url_link', $row->URL_LINK, [ 'class' => 'form-control mb-1', 'data-validation-required-message' => 'This field is required', 'placeholder' => 'Enter url_link', 'tabindex' => 5]) !!}
                                ...
                                <div class="col-md-6">
                                    <div class="form-group {!! $errors->has('is_feature') ? 'error' : '' !!}">
                                        ...
                                        <div class="controls">
                                            {!! Form::select('is_feature', ['1'=> 'YES','0'=> 'NO'], $row->IS_FEATURE,[ 'class' => 'form-control mb-1', 'data-validation-required-message' => 'This field is required', 'placeholder' => 'IS FEATURE', 'tabindex' => 5]) !!}
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group {!! $errors->has('banner') ? 'error' : '' !!}">
                                        <label class="active">Desktop Banner Image <span class="text-danger">*</span></label>
                                        <div class="controls">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group {!! $errors->has('is_active') ? 'error' : '' !!}">
                                        ...
                                        <div class="controls">
                                            <div class="fileupload @if(!empty($row->MOBILE_BANNER))  {{'fileupload-exists'}} @else {{'fileupload-new'}} @endif "
                                                 data-provides="fileupload">
                                                <span class="fileupload-preview fileupload-exists thumbnail" style="max-width: 150px; max-height: 120px;">
                                                ...
                                                {!! Form::file('mobile_banner', Null,[ 'class' => 'form-control mb-1', 'data-validation-required-message' => 'This field is required', 'placeholder' => 'IS ACTIVE', 'tabindex' => 5]) !!}
                                                </label>
                                                <a href="#" class="btn fileupload-exists btn-danger  btn-sm" data-dismiss="fileupload" id="remove-thumbnail">
                                                <i class="la la-times"></i> Remove
                                                </a>
