                  ...
                  <div class="row">
                     ...
                     <div class="col-md-6">
                        <div class="form-group {!! $errors->has('tags') ? 'error' : '' !!}">
                           ...
                           <div class="controls">
                              {!! Form::text('tags', null, [ 'class' => 'form-control mb-1', 'data-validation-required-message' => 'This field is required', 'placeholder' => 'Lifestyle,', 'tabindex' => 5]) !!}
                     ...
                     <div class="col-md-6">
                        <div class="form-group {!! $errors->has('author') ? 'error' : '' !!}">
                           ...
                           <div class="controls">
                              {!! Form::text('author', null, [ 'class' => 'form-control mb-1', 'data-validation-required-message' => 'This field is required', 'placeholder' => 'Lifestyle,', 'tabindex' => 6]) !!}
